...
**DClaw Water** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8053` (FastAPI)
- **Frontend Port:** `3053` (Next.js)
- **Database:** `dclaw_water` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3053`
